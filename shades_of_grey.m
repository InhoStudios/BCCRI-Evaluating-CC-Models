function [white_R, white_G, white_B, output_img] = shades_of_grey(input_img, p)
    disp(strcat("Running shades of grey model with p-value of ", string(p), "..."));
    ...
    disp("Image recombined with RGB channels scaled for skin colour");
end